    ...
    <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="操作" width="180px" >
            <template slot-scope="scope">
                ...
                <el-tooltip effevt="dark" content="分配角色" placement="top" :enterable="false" >
        ...
        queryInfo:{
         ...
         addFormrules:{
             username:[
                 ...
                 {min:3,max:10,message:'请输入字符串3~10个',trigger:"blur"}
             ],
             password:[
                 {required:true,message:'请输入密码',trigger:"blur"},
                 {min:6,max:15,message:'请输入字符串6~15个',trigger:"blur"}
             ],
             email:[
